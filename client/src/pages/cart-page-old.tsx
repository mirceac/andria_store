            ...
            <div className={`${isMobile ? 'p-4' : 'border-t p-4'} bg-gray-50`}>
              <div className={`${isMobile ? '' : 'max-w-md ml-auto'}`}>
                <div className="flex justify-between mb-2">
                  <span className={`${isMobile ? 'text-sm' : 'text-sm'} text-muted-foreground`}>Subtotal:</span>
                  <span className={`${isMobile ? 'text-sm' : 'text-sm'} font-medium`}>${total.toFixed(2)}</span>
                </div>
                <div className="flex justify-between mb-4">
                  <span className={`${isMobile ? 'text-sm' : 'text-sm'} text-muted-foreground`}>Shipping:</span>
                  <span className={`${isMobile ? 'text-sm' : 'text-sm'} font-medium`}>Free</span>
                </div>
                <div className="flex justify-between border-t pt-4">
                  <span className={`${isMobile ? 'text-base' : 'text-base'} font-semibold`}>Total:</span>
                  <span className={`${isMobile ? 'text-lg' : 'text-lg'} font-bold`}>${total.toFixed(2)}</span>
                </div>
                <Button 
